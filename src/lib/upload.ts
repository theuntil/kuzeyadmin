...
/*
 * ⚠ REKLAM AYRI KLASÖRDE.
 * `library` içine karışsaydı medya kitaplığında reklam
 * görselleri de listelenir, yönetici karıştırırdı.
 */
export type Onek =
  "avatar" | "library" | "editor" | "mail" | "haber" | "reklam";
