...
export async function POST(req: NextRequest) {
  ...
  if (!onek
      || !["avatar", "library", "editor", "mail", "haber", "reklam"].includes(onek)) {
  ...
  /*
   * ⚠ REKLAM YALNIZCA YÖNETİCİ.
   * Reklam görselleri siteye herkese gösteriliyor; yükleme
   * yetkisi en dar tutulmalı.
   */
  if (onek === "reklam" && seviye < ROL_SIRASI.admin) {
